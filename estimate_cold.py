...
# SW: Model with 33481M total params, 262M largest layer params.
    ...
    for combination in cartesian_product:
        ...
        estimate_zero2_model_states_mem_needs_all_cold(total_params=33481000000, num_gpus_per_node=num_gpus, num_nodes=num_nodes, additional_buffer_factor=buffer_factor)

        print('estimate_zero3_model_states_mem_needs_all_cold\n')
        estimate_zero3_model_states_mem_needs_all_cold(total_params=33481000000, largest_layer_params=262000000, num_gpus_per_node=num_gpus, num_nodes=num_nodes, additional_buffer_factor=buffer_factor)
        print('-------------------------------------------------------------------------------------------------------------\n\n\n\n')
