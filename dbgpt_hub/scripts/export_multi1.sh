...
checkpoint_count_list=(600 1250 1650)  # 请根据实际需求修改这个列表
model="CodeLlama-13b-Instruct-hf-ds-20240202_195315-tpl_llama2-src_12000-tgt_5000-r_64-a_128-lt_q_proj_v_proj-lr_2e-4-stream_false-fp16-DBTHub_Prompt-chase-WB-FIO-SF"
# 循环执行Python命令
