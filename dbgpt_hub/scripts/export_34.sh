...
checkpoint_count_list=(1500)  # 请根据实际需求修改这个列表
model="CodeLlama-34b-Instruct-hf-20240124_195529-xds2-qv-DBTHub_Prompt-chase-WB-FIO"

# CodeLlama-34b-Instruct-hf-20240124_195529-xds2-qv-DBTHub_Prompt-chase-WB-FIO
# 循环执行Python命令
